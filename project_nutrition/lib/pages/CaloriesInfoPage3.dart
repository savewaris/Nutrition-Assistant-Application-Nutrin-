...
class CaloriesInfoPage3 extends StatefulWidget {
  const CaloriesInfoPage3({Key? key}) : super(key: key);

  @override
  State<CaloriesInfoPage3> createState() => _CaloriesInfoPageState3();
}

class _CaloriesInfoPageState3 extends State<CaloriesInfoPage3> {
  String _mealData = '';
